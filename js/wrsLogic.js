...
(function () {
    ...
    function renderStart() {
        ...
        $c().innerHTML = '<div class="card shadow border-primary mx-auto" style="max-width:580px">'
            ...
            + '<h4 class="mb-0 fw-bold" style="color:#fff">WRS Practice Assessment</h4>'
            + '<p class="mb-0 small" style="color:rgba(255,255,255,.8)">Nevada CTECS Workplace Readiness Skills</p>'
            + '</div>'
            ...
            + '<strong>' + total + ' scoreable items</strong>'
            + '<ul class="mb-0 mt-2">'
