/* /js/login-logic-test.js */

/**
 * Student Portal Logic (MariaDB Transition)
 * Handles: Login, Registration, and Conditional Clock-In
 */
...
function handleNavigationFlow() {
    ...
    const redirectTo = urlParams.get('redirect') || "/student/grades-test.html";
        ...
        loginForm.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                if (data.shift && data.shift.isRegular) {
                    ...
                    document.getElementById('test-mode-alert').classList.add('d-none');
