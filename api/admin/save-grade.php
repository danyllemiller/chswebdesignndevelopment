<?php
// DEPRECATED — superseded by POST /api/admin/save-grade in server/api.js (writes to `responses` table).
...
// Ensure the exam exists so foreign-key-style consistency is maintained
$stmt = $db->prepare(
